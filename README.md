...
- `data/`: Contains the dataset metadata (`lyrics_dataset.csv`). *Note: Audio files are excluded due to size constraints.*
- `notebooks/`: Contains the complete source code `CSE425_Neural_Networks_Project.ipynb`.
- `results/`: Visualizations of latent space clustering.
